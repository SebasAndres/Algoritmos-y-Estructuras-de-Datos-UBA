...
class InternetToolkitTests {
    ...
    private static <T extends Comparable<T>> boolean mismosarr(T[] a, T[] b){
    ...
    public void tcpReorderOrdenados(){
        ...
        assertTrue(mismosarr(ordenados,paquetes));
    ...
    public void kTopRoutersInstanciaChica(){
        ...
        assertTrue(mismosarr(todos_cumplen,routers));
        ...
        for(int k = 0; k <= n; k++){
            ...
            assertTrue(mismosarr(pedazo_respuesta,pedazo_ordenado));
